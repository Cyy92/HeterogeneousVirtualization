...
import (
	...
	"github.com/Cyy92/HeterogeneousVirtualization/faas-cli/versioncontrol"
...
var RuntimeCmd = &cobra.Command{
	...
	Long: `
	runtime command create, list the runtime used in creation faas function
	`,
...
func DownloadCloudInits(path, cloudinitURL string) error {
	args := map[string]string{"dir": path, "repo": cloudinitURL}
	fmt.Println(cloudinitURL)
	if err := versioncontrol.GitClone.Invoke(".", args); err != nil {
		return err
	}
