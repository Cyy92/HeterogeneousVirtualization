...
var infoCmd = &cobra.Command{
	...
	Short: "Display FaaS function information",
	Long: `
	Display FaaS function information
`,
	Example: `  faas-cli function info -f config.yml
	faas-cli function info -g localhost:31113
                  `,
	PreRunE: preRunInfo,
