...
import (
	...
	watcher "github.com/Cyy92/HeterogeneousVirtualization/faas-cli/pb"
...
var runCmd = &cobra.Command{
	...
	Short: "Run FaaS Image in local",
	Long: `
	Run FaaS Image that created when execute "build" command for debugging in local
	`,
	Example: `
	faas-cli function run echo-service -f config.yaml
	echo "hi" | faas-cli function run echo-service
	`,
	PreRunE: preRunRun,
