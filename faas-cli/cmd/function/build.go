...
var buildCmd = &cobra.Command{
	...
	Short: "Build FaaS function Image",
	Long: `
	Build FaaS function Image via the supplied YAML config 
	`,
	Example: `
	faas-cli function build 
	faas-cli function build -f ./config.yaml
	faas-cli function build -v
	`,
	PreRunE: preRunBuild,
